# n is the cardinality of the ground set. It can be set via input-parameter with -D n=...
# To generate an MPS file, call "zimpl -o outputname -t mps -D n=cardinality chvatal_optprob_red.zpl"
param n := 6;
